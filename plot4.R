...
# plot 1 graph
plot(data$DateTimeString, data$Global_active_power, type = "l", ylab = "Global Active Power(kilowatts)", xlab = "", xaxt = "n", cex = 0.1)
...
# plot 4 graph
plot(data$DateTimeString, data$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global reactive power", xaxt = "n", cex = 0.1)
axis(1, at = c(base_time, base_time + (3600 * 24), base_time + (3600 * 24 * 2)), labels = c("Thursday", "Friday", "Saturday"))
